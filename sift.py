...
def keypoint_match(img1, img2, max_n_match=100, draw=True):
    ...
    write_and_show('img1_gray.jpg', img1_gray)
    write_and_show('img2_gray.jpg', img2_gray)
    ...
    if draw:
        ...
        write_and_show('img1_keypoints.jpg', img1_keypoints)
        ...
        outImage  = None,
        flags     = cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
        write_and_show('img2_keypoints.jpg', img2_keypoints)
